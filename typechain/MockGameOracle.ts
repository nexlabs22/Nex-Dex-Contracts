...
export interface MockGameOracleInterface extends utils.Interface {
  contractName: "MockGameOracle";
  functions: {
    "EXPIRY_TIME()": FunctionFragment;
    "cancelOracleRequest(bytes32,uint256,bytes4,uint256)": FunctionFragment;
    "fulfillOracleScoreRequest(bytes32,bytes32,bytes32,bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "fulfillOracleScoreRequest",
...
export interface MockGameOracle extends BaseContract {
  contractName: "MockGameOracle";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockGameOracleInterface;
