...
export interface NFTBankConsumerInterface extends utils.Interface {
  contractName: "NFTBankConsumer";
  functions: {
...
export interface NFTBankConsumer extends BaseContract {
  contractName: "NFTBankConsumer";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTBankConsumerInterface;
