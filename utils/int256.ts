...
import { instanceOfUnSignedBigNumber } from "./uint256";

export default int256;

export declare interface int256 extends BigNumber {};

const BN = BigNumber.clone({ DECIMAL_PLACES: 18, ROUNDING_MODE: 1 });
export function int256(value: number | string | int256 | uint256, base = 10): BigNumber {
  ...
  if (instanceOfUnSignedBigNumber(value)) return BN(value.value, base);
